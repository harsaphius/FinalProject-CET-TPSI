            ...
            <div class="col-md-9 ">
                <div class="nav-wrapper position-relative end-0">
                    <ul class="nav nav-pills nav-fill p-1">
                        <li class="nav-item">
                            <asp:LinkButton runat="server" class="nav-link mb-0 px-0 py-1" ID="listStudents" OnClientClick="return handleLinkButtonClick('List');" href="javascript:void(0);">Listar
                            </asp:LinkButton>
                        </li>
                        <li class="nav-item">
                            <asp:LinkButton class="nav-link mb-0 px-0 py-1" runat="server" ID="insertStudents" OnClientClick="return handleLinkButtonClick('Insert');" href="javascript:void(0);">Inserir
                            </asp:LinkButton>
                        </li>
                        <li class="nav-item">
                            <asp:LinkButton runat="server" class="nav-link mb-0 px-0 py-1" ID="editStudents" OnClientClick="return handleLinkButtonClick('Edit');" href="javascript:void(0);"> Editar/Eliminar
                            </asp:LinkButton>
                        </li>
                    </ul>
                </div>
                ...
                <div id="listStudentsDiv" class="hidden">List</div>
        ...
        function handleLinkButtonClick(action) {
            ...
            switch (action) {
                case 'List':
                    ...
                    document.getElementById('editStudentsDiv').classList.add('hidden');
                    document.getElementById('insertStudentsDiv').classList.add('hidden');
                    title = "Listar Formandos";
                    break;
                case 'Edit':
                    url = '../ManageStudents.aspx?Edit';
                    document.getElementById('editStudentssDiv').classList.remove('hidden');
                    document.getElementById('listStudentsDiv').classList.add('hidden');
                    document.getElementById('insertStudentsDiv').classList.add('hidden');
                    title = "Editar Formandos";
                    break;
                case 'Insert':

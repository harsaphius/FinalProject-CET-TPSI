...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <asp:UpdatePanel runat="server">
                ...
                <div class="container-fluid">
                    <div class="nav-wrapper position-relative end-0">
                        <ul class="nav nav-pills nav-fill p-1">
                            <li class="nav-item">
                                <asp:LinkButton runat="server" class="nav-link mb-0 px-0 py-1" ID="listStudents" href="../ManageStudents.aspx?List">Listar
                                </asp:LinkButton>
                            </li>
                            <li class="nav-item">
                                <asp:LinkButton class="nav-link mb-0 px-0 py-1" runat="server" ID="insertStudents" href="../ManageStudents.aspx?Insert">Inserir
                                </asp:LinkButton>
                            </li>
                            <li class="nav-item">
                                <asp:LinkButton runat="server" class="nav-link mb-0 px-0 py-1" ID="editStudents" href="../ManageStudents.aspx?Edit"> Editar/Eliminar
                                </asp:LinkButton>
                            </li>
                        </ul>
                    </div>
            ...
            <Triggers>
                <asp:AsyncPostBackTrigger ControlID="listStudents" />
                <asp:AsyncPostBackTrigger ControlID="insertStudents" />
                <asp:AsyncPostBackTrigger ControlID="editStudents" />
            </Triggers>
        </asp:UpdatePanel>
        <div id="listStudentsDiv" class="pageDiv">List</div>
        <div id="insertStudentsDiv" class="pageDiv">
    ...
    <!-- End of Registration Completion -->
        ...
        <div id="editSudentsDiv" class="pageDiv"></div>
    </div>
    <script>

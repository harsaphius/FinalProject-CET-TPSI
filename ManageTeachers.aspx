...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <div class="row" style="margin-top: 15px">
            <div class="col-md-6 col-md-6 text-start" style="padding-left: 35px;">
                <asp:Button runat="server" CssClass="btn btn-primary" Text="Inserir Novo Formador" ID="btnInsertTeacher" OnClientClick="showInsert(); return false;" />
                <asp:Button runat="server" CssClass="btn btn-primary" Text="Inserir da Lista de Utilizadores" ID="btnInsertTeacherFromList" OnClientClick="showUserList(); return false;" />
                ...
                <asp:Button runat="server" CssClass="btn btn-primary hidden" Text="Voltar" ID="btnBackFromModules" OnClientClick="showListModules(); return false;" />
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mb-4">
                                ...
                                <asp:UpdatePanel ID="updatePanelUsersForTeachers" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <div class="card-body">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="align-middle font-weight-bold text-center">
                                                                ...
                                                                <div class="form-check">
                                                                    <asp:CheckBox runat="server" ID="chkBoxUser" />
                                                                </div>
                                            ...
                                            <div>
                                                <asp:Button runat="server" ID="btnEnrollUserAsTeacher" class="btn btn-outline-primary btn-sm mb-0 text-end" CausesValidation="false" CommandArgument='<%# Eval("CodUser") %>' Text="Inscrever" />
                                                                                ...
                                                                                <ContentTemplate>
                                                                                    ...
                                                                                    <div class="card card-footer">
                                                                                        <div class="col-md-12 align-items-center">
                                                                                            ...
                                                                                            <asp:Button runat="server" ID="btnSubmit" ValidationGroup="Page2" CausesValidation="True" class="btn btn-outline-primary btn-sm mb-0" Text="Submeter"></asp:Button>
                                                                                        </div>
                        ...
                        <div id="ModulesRegisterForTeacher" class="hidden">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div>
                                                                <asp:Button runat="server" ID="btnEnroll" class="btn btn-outline-primary btn-sm mb-0 text-end" CausesValidation="false" CommandName="Edit" CommandArgument='<%# Eval("CodUtilizador") %>' Text="Inscrever" />
    ...
    <script>
        function showInsert() {
            ...
            var btnInsert = document.getElementById('<%= btnInsertTeacher.ClientID %>');
            var btnInsertTeacherFromList = document.getElementById('<%= btnInsertTeacherFromList.ClientID %>')
    ...
    <script>
        function showListModules() {
            var listDiv = document.getElementById('listTeachersDiv');
            var coursesDiv = document.getElementById('ModulesRegisterForTeacher');
            var btnInsert = document.getElementById('<%= btnInsertTeacher.ClientID %>');
            var btnBack = document.getElementById('<%= btnBackFromModules.ClientID %>');

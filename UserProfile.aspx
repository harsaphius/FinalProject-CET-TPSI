                        ...
                        <div class="col-lg-6 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                            <div class="nav-wrapper position-relative end-0">
                                <ul class="nav nav-pills nav-fill p-1 bg-transparent">
                                    ...
                                    <li class="nav-item">
                                        <asp:LinkButton class="btn btn-link pe-3 ps-0 mb-0 ms-auto" ID="lbtDisponibilidade" Visible="False" CausesValidation="False" OnClick="lbtDisponibilidade_OnClick" runat="server">
                                            <i class="fas fa-time"></i>
                            ...
                            <div class="card-body p-3">
                                <ul class="list-group">
                                    <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                                        ...
                                        <asp:Button runat="server" ID="btnExport" OnClick="btnExport_OnClick" class="btn btn-link pe-3 ps-0 mb-0 ms-auto" Text="Exportar Perfil"></asp:Button>
                                    </li>
                                    <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                                        <div class="avatar me-3">
                                        ...
                                        <a class="btn btn-link pe-3 ps-0 mb-0 ms-auto">Reply</a>
                                    </li>
                                    <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                                        <div class="avatar me-3">
